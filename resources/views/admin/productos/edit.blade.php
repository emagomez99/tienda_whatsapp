                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        @if($producto->url_imagen)
                            <div class="mb-2">
                                <img src="{{ asset('storage/' . $producto->url_imagen) }}" alt="" style="max-width: 200px;" class="rounded">
                            </div>
                        @endif
                    ...
                    <div id="etiquetas-container">
                        @forelse($producto->etiquetas as $index => $etiquetaProd)
                            <div class="row mb-2 etiqueta-row">
                                <div class="col-md-5">
                                    <select class="form-select" name="etiquetas[{{ $index }}][etiqueta_id]">
                                ...
                                <div class="col-md-5">
                                    <input type="text" class="form-control" name="etiquetas[{{ $index }}][valor]" placeholder="Valor (ej: Filtro, Auto)" value="{{ $etiquetaProd->pivot->valor }}">
                                </div>
                                <div class="col-md-2">
                    ...
                    <div id="especificaciones-container">
                        @forelse($producto->especificaciones as $index => $espec)
                            <div class="row mb-2 especificacion-row">
                                <div class="col-md-5">
                                    <input type="text" class="form-control" name="especificaciones[{{ $index }}][clave]" placeholder="Clave (ej: Peso)" value="{{ $espec->clave }}">
                                </div>
                                <div class="col-md-5">
                                    <input type="text" class="form-control" name="especificaciones[{{ $index }}][valor]" placeholder="Valor (ej: 1.75)" value="{{ $espec->valor }}">
                                </div>
                                <div class="col-md-2">
