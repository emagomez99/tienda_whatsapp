...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h3><i class="bi bi-plus-circle"></i> Nuevo Ítem de Menú</h3>
                ...
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        ...
                        <select name="filtro_stock" id="filtro_stock" class="form-select">
                            <option value="todos" {{ old('filtro_stock', 'todos') === 'todos' ? 'selected' : '' }}>Todos los productos</option>
                            <option value="con_stock" {{ old('filtro_stock') === 'con_stock' ? 'selected' : '' }}>Solo con stock</option>
                            <option value="con_stock_y_encargue" {{ old('filtro_stock') === 'con_stock_y_encargue' ? 'selected' : '' }}>Con stock y por encargue</option>
                        </select>
                    </div>
                                ...
                                <div class="border rounded p-2 bg-light" style="min-height: 150px;">
                                    <ul class="list-group list-group-flush" id="filtros-seleccionados">
                                        @foreach($filtrosActuales as $index => $filtroId)
                                            ...
                                            @if($etiquetaFiltro)
                                                @php $mostrarTodosEtiqueta = (bool) old('filtros_todos.' . $etiquetaFiltro->id, true); @endphp
