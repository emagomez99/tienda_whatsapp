...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2><i class="bi bi-plus-circle"></i> Nueva Etiqueta</h2>
            ...
            <div class="card-body">
                <form action="{{ route('admin.etiquetas.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('nombre') is-invalid @enderror" id="nombre" name="nombre" value="{{ old('nombre') }}" placeholder="Ej: Categoria, Modelo, Marca" required>
                        @error('nombre')
                    ...
                    <div class="mb-3">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="visible_usuarios" name="visible_usuarios" value="1" {{ old('visible_usuarios', true) ? 'checked' : '' }}>
